...
public class MovieController {
	...
	public ResponseEntity<Response> register(@RequestBody MovieDTO moviedto){
		System.out.println("in controller");
		Response response = movieService.createMovie(moviedto);
		System.out.println(response);
		return new ResponseEntity<>(response, HttpStatus.OK);

	}
	
	@PostMapping("/addActorProducerToMovie")
	public ResponseEntity<Response> addActorProducerToMovie(@RequestParam long movieId,long producerId,List<String> actors){
		System.out.println("in controller");
		Response response = movieService.addActorProducerToMovie(movieId,producerId,actors);
		System.out.println(response);
		return new ResponseEntity<>(response, HttpStatus.OK);
	...
	List<Movie> getMovie(@RequestParam long movieId) {
