...
public class LinkedList<T> {
	...
	/**
	 * @param T : It takes generic data type as command line argument
	 * @purpose : This method is used to search a 
	 * specific element in a linkedlist
	 * @return : boolean
	 **/
	...
	public void writeOnFile() {
		...
		try (BufferedWriter bw = new BufferedWriter(new FileWriter("/home/user/Downloads/JavaProgram/src/file.txt"))) {
			bw.write(frist);		
			bw.close();
	...
	public void writeOnFile1() { 
		Node temp = head;
		while (temp != null) {
			temp = temp.next;
		}

		try (BufferedWriter bw = new BufferedWriter(new FileWriter("/home/user/Downloads/JavaProgram/src/fileint.txt"))) 
		{	
			bw.close();
